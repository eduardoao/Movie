...
To update the database use this command from the Web project folder (replace `Movie` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Movie.Infrastructure/Movie.Infrastructure.csproj -s Movie.Web.csproj
```
